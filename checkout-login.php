...
{	
	...
	public function MainBodyContent()
	{
		...
		echo '<div class="register-page"><h3>Already have an account? Login below.</h3>', $this->user->loginForm(), '<h3>Register</h3>', $this->user->RegisterForm1('', 'Disclaimer: Fusce laoreet magna nec magna rhoncus non cursus leo interdum. Vivamus a est sed erat pellentesque tempor sit amet vitae velit.'), '</div>';
