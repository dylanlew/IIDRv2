...
{	private $filter = '';
	...
	{	ob_start();
		echo '<table><tr class="newlink"><th colspan="6"><a href="venueedit.php">Create new venue</a></th></tr><tr><th>Venue</th><th>Name</th><th>Address</th><th>Map ref.</th><th>Actions</th></tr>';
		...
		{	$venue = new AdminVenue($venue_row);
			...
			echo '</td><td><a href="venueedit.php?id=', $venue->id, '">edit</a>';
