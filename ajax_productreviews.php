...
{		
	...
	{	
		...
		switch ($_GET['ptype'])
		{	case 'course':
				$subject = 'IIDR course review needs moderating';
				echo 'A new course review has been submitted ...', $sep, 'admin link: ', SITE_URL, 'iiadmin/coursereviews.php?id=', $_GET['prodid'];
				break;
			case 'product':
			default:
				$subject = 'IIDR product review needs moderating';
				echo 'A new product review has been submitted ...', $sep, 'admin link: ', SITE_URL, 'iiadmin/productreviews.php?id=', $_GET['prodid'];
		}
