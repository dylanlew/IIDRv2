...
{	
	...
	{	
		echo '<div id="sidebar" class="col">', $this->store->StoreMenu($this->category->id), $this->SideMenuSpecialOffers(), $this->SideMenuBestSellers(), '</div><div class="col3-wrapper-with-sidebar"><div class="storeShelf"><div id="storeshelf_header"><h1>Welcome to the IIDR Store', $this->SortForm($this->category->id), '</h1>', $this->OutputBanner(), '</div>', $this->StoreListing(), '</div></div>';
