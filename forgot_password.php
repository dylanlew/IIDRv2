...
{	var $password_sent = '';
	...
	{	
		echo '<div class="course-content-wrapper">', $this->page->HTMLMainContent();
		if (!$this->user->id)
	...
	{	ob_start();
		echo '<form action="forgot_password.php" class="form" method="post" /><p><label>The email address you used to register</label><input type="text" name="fpemail" value="', $this->InputSafeString($_POST['fpemail']), '" /></p><p><input type="submit" class="submit" value="Get new password" /></p></form>';
		return ob_get_clean();
