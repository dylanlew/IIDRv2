...
{	
	...
	{	ob_start();
		...
		echo '</ul><div class="clear"></div></div><table><tr><th', $rowspantext, '>Booking<br />Number</th><th', $rowspantext, '>Name<br />Email</th><th', $rowspantext, '>Ticket</th><th', $rowspantext, '>Booked</th>',
