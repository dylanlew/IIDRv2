<?php
class AskImamCategory extends BlankItem
{	var $subcats = array();
	...
	{	if ($this->details['parentcat'] && ($parent = new AskImamCategory($this->details['parentcat'])) && $parent->id)
		{	return $parent;
		}
	} // end of fn GetParent
