...
class AdminStoreOrder extends StoreOrder
{
	...
	{	ob_start();
		...
		{	
			echo '<tr><td>', $this->InputSafeString($item['ptype']), '</td><td>', $this->InputSafeString($item['title']), '</td><td>', (int)$item['qty'], '</td><td class="num">', number_format($item['price'], 2), '</td><td class="num">', number_format($item['pricetax'], 2), '</td><td class="num">', number_format($item['totalprice'], 2), '</td><td class="num">', number_format($item['totalpricetax'], 2), '</td></tr>';
