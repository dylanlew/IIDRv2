...
{	
	...
	{	echo $this->OutputBanner(), '<div id="sidebar" class="col courselist_sidebar">', $this->GetSidebarCourses(), $this->GetSidebarQuote(), '</div><div class="col3-wrapper-with-sidebar courselist_main">';
